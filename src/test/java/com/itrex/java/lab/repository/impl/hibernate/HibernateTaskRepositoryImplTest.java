...
class HibernateTaskRepositoryImplTest extends BaseRepositoryTest {
    ...
    public HibernateTaskRepositoryImplTest () {
        super();
        repository = new HibernateTaskRepositoryImpl(getSessionFactory());
        userRepository = new HibernateUserRepositoryImpl(getSessionFactory());
    }
    ...
    @Test
    void removeUserByTask_existUserAndTaskNonDB_shouldReturnTrueTest() throws CRMProjectRepositoryException {
        //given
    ...
    @Test
    void removeUserByTask_existUserAndTask_shouldReturnFalseTest() throws CRMProjectRepositoryException {
        //given
        User user = userRepository.selectById(1);

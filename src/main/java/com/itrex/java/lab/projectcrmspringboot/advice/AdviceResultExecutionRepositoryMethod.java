package com.itrex.java.lab.projectcrmspringboot.advice;
...
public class AdviceResultExecutionRepositoryMethod {
    ...
    @AfterReturning(value = "execution(* com.itrex.java.lab.projectcrmspringboot.repository.*.select*(..))", returning = "entity")

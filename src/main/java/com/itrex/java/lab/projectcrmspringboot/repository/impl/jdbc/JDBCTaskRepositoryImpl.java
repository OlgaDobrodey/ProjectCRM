...
public class JDBCTaskRepositoryImpl implements TaskRepository {
    ...
    private static final String SELECT_ALL_TASKS_FOR_USER = "SELECT tasks_id FROM user_task WHERE users_id = ";
    private static final String INSERT_TASK_QUERY = "INSERT INTO task(title, status, deadline, info) VALUES (?, ?, ?, ?)";
